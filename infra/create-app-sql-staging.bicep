...
var sqlServerNameProd  = 'grrhe-prod-crf-sqlserver-${uniqueSuffix}'
var sqlServerNameStaging  = 'grrhe-staging-crf-sqlserver-${uniqueSuffix}'
...
resource sqlDatabaseStaging 'Microsoft.Sql/servers/databases@2021-02-01-preview' = {
  parent: sqlServerStaging
  name: databaseName
  location: location
  tags: {
...
resource appServicePlanWindows 'Microsoft.Web/serverfarms@2020-12-01' = {
  name: 'grrhe-crf-windows-asp-001'
  location: location
  sku: {
    name: 'S1'
    tier: 'Standard'
...
resource srcControls 'Microsoft.Web/sites/sourcecontrols@2021-01-01' =  {
  ...
  name: 'web'
  properties: {
    repoUrl: 'https://github.com/grmrh/CarvedRockFitness'
    branch: 'main'
